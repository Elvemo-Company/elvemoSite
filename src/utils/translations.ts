export const translations = {
  en: {
    ...
    about: {
      ...
      mission: {
        title: "Our Mission",
        description1: "At elvemo, we believe every business deserves a great website – without hassle, delays, or overspending.",
    ...
    footer: {
      description: "elvemo is a creative tech agency focused on high-quality digital experiences for modern brands and businesses.",
      quickLinks: {
        title: "Quick Links",
        links: [
          "Home",
  ...
  pl: {
    ...
    about: {
      ...
      mission: {
        title: "Nasza Misja",
        description1: "W elvemo wierzymy, że każda firma zasługuje na świetną stronę internetową – bez komplikacji, bez przeciągania, bez przepłacania.",
    ...
    footer: {
      description: "elvemo to kreatywna agencja technologiczna specjalizująca się w wysokiej jakości doświadczeniach cyfrowych dla postępowych firm i marek.",
      quickLinks: {
        title: "Szybkie Linki",
        links: [
          "Strona Główna",
