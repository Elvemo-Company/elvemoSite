...
const Services: React.FC = () => {
  ...
  const desktopAccordionVariants = {
    open: { opacity: 1, height: 'auto', y: 0, transition: { duration: 0.4, ease: [0.04, 0.62, 0.23, 0.98] } },
    collapsed: { opacity: 0, height: 0, y: -10, transition: { duration: 0.4, ease: [0.04, 0.62, 0.23, 0.98] } }
  };
              ...
              <AnimatePresence initial={false}>
                {expandedService === index && (
                  <motion.div
                    ...
                    animate="open"
                    exit="collapsed"
                    variants={isMobile ? mobileAccordionVariants : desktopAccordionVariants}
